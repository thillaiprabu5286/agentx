...
class Cmsmart_AdminTheme_Block_Adminhtml_Block_Dashboard_Orders_Grid extends Mage_Adminhtml_Block_Dashboard_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('created_at', array(
            ...
            'format'    => 'M/d/y', // Format of the column 2014/06/03
        ));
