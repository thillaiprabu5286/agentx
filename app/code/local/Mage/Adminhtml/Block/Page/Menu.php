...
//        }
    ...
    public function getMenuLevel($menu, $level = 0)
    {
        ...
        foreach ($menu as $item) {
            if($item['sort_order'] == 10){
                $menu_icon = 'dashboard';
            }elseif ($item['sort_order'] == 20) {
                $menu_icon = 'sales';
            }elseif ($item['sort_order'] == 30) {
                $menu_icon = 'catalog';
            }elseif ($item['sort_order'] == 40) {
                $menu_icon = 'customers';
            }elseif ($item['sort_order'] == 50) {
                $menu_icon = 'promotions';
            }elseif ($item['sort_order'] == 60) {
                $menu_icon = 'newsletter';
            }elseif ($item['sort_order'] == 70) {
                $menu_icon = 'cms';
            }elseif ($item['sort_order'] == 80) {
                $menu_icon = 'reports';
            }elseif ($item['sort_order'] == 90) {
                $menu_icon = 'system';
            }else{
                $menu_icon = 'menu_icon';
            }
            $html .= '<li ' . (!empty($item['children']) ? 'onmouseover="Element.addClassName(this,\'over\')" '
                ...
                . ' level'. $level .' '.$menu_icon.'"> <a href="' . $item['url'] . '" '
